...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyle = "flex items-center justify-center px-4 py-2 rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-[#09090b]";
  const variants = {
    ...
    secondary: "bg-[#27272a] hover:bg-[#3f3f46] text-gray-200 border border-gray-700 focus:ring-gray-500",
    ...
    icon: "p-2 bg-transparent hover:bg-white/10 text-gray-400 hover:text-white rounded-md focus:ring-indigo-500/50",
