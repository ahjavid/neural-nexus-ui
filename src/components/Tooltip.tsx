  ...
  return (
    ...
    >
      ...
      {isVisible && (
        ...
        >
          <div className="relative px-2.5 py-1.5 text-xs font-medium text-white bg-gray-900 dark:bg-gray-700 rounded-md shadow-lg whitespace-nowrap animate-in fade-in duration-150">
            {content}
            <div 
