  ...
  return (
    <div className="flex h-full bg-[#09090b] text-gray-200 font-sans overflow-hidden selection:bg-indigo-500/30">
      ...
      <div className="flex-1 flex flex-col h-full relative bg-[#09090b]">
        ...
        {/* Chat Feed */}
        <div className={`flex-1 min-h-0 px-4 md:px-6 py-2 space-y-6 ${messages.length > 0 ? 'overflow-y-auto scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-transparent' : 'overflow-y-auto scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-transparent'}`}>
          {messages.length === 0 ? (
            <div className="min-h-full flex flex-col items-center justify-start py-8 md:py-12 text-gray-500 px-4">
              ...
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full mb-6 transition-all flex-shrink-0 ${
                ...
                <span className={`text-xs font-medium ${
                  ...
                  {connectionStatus === 'connected' ? `Connected • ${models.length} model${models.length !== 1 ? 's' : ''}` :
